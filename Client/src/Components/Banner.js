...
const Banner = () => {
  ...
  return (
    ...
    <div className='w-screen h-full object-cover'>
        <img src={data[0]} alt='imageOne' loading='priority'/>
    </div>
    <div className='w-screen h-full object-cover'>
        <img src={data[1]} alt='imageTwo' />
    </div>
   
    <div className='w-screen h-full object-cover'>
        <img src={data[2]} alt='imageThree' />
    </div>
    <div className='w-screen h-full object-cover'>
        <img src={data[3]} alt='imageThree' />
    </div>
    </div>
