...
const ProductCard = ({product}) => {
  ...
  return (
    ...
    <img className='"w-full h-full object-cover group-hover:scale-110 duration-500"' src={product.image} alt="image"/>
    </div>
    <div className="w-full border-[1px] px-2 py-4">
      ...
      <div className='flex gap-2 transform group-hover:translate-x-24 transition-transform duration-500'>
        <p className='className="line-through text-gray-500"'>{product.oldPrice}</p>
